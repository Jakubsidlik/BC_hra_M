...
export const cardsDatabase: Record<string, CardData> = {
  ...
  '0': { symbol: '0', type: 'number', count: 10, image: '/cards/0.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  '1': { symbol: '1', type: 'number', count: 10, image: '/cards/1.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  '2': { symbol: '2', type: 'number', count: 10, image: '/cards/2.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  '3': { symbol: '3', type: 'number', count: 10, image: '/cards/3.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  '4': { symbol: '4', type: 'number', count: 10, image: '/cards/4.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  '5': { symbol: '5', type: 'number', count: 10, image: '/cards/5.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  '6': { symbol: '6', type: 'number', count: 10, image: '/cards/6.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  '7': { symbol: '7', type: 'number', count: 10, image: '/cards/7.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  '8': { symbol: '8', type: 'number', count: 10, image: '/cards/8.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  '9': { symbol: '9', type: 'number', count: 10, image: '/cards/9.svg', hasEffect: true, effects: { optionA: { id: 'EFF_001', name: 'Bonus ke lízání', description: 'Dobrání 1 karty navíc na začátku každého kola.', target: 'SELF' } } },
  ...
  'π': { 
    ...
    hasEffect: true,
    effects: {
      optionA: { id: 'EFF_002', name: 'Výměna L', description: 'Možnost výměny 1 karty z vlastního řetězce L za kartu z L oponenta.', target: 'SELF' }
    }
  },
  'e': { 
    symbol: 'e', 
  ...
  '/': { 
    ...
    hasEffect: true,
    effects: {
      optionA: { id: 'EFF_009', name: 'Náhled balíčku', description: 'Náhled na 3 vrchní karty balíčku a jejich libovolné přerovnání.', target: 'OPPONENT' }
    }
  },
