    ...
    >
      {isDerivativeCard && (
        <button
          ...
          className="absolute right-1 top-1 rounded-full border border-white/30 bg-slate-900/90 px-1.5 py-0.5 text-[9px] font-black text-white"
        >
          {derivativeLabel}
        </button>
      )}
