...
export function DiscardZone({ discardCount, deckCount, isDiscarding }: DiscardZoneProps) {
  ...
  return (
    <div 
      ref={setNodeRef}
      className={`w-20 h-28 lg:w-32 lg:h-44 shrink-0 rounded-2rem border-2 flex flex-col items-center justify-center text-white font-bold p-2 shadow-lg transition-all duration-300 relative z-20
