      ...
      {hasLeftRightSlots && (
        <>
          <div
            ...
            style={isOverLeft ? { boxShadow: '0 0 0 2px rgba(255,255,255,0.9), 0 0 16px rgba(255,255,255,0.7)' } : undefined}
          />
          <div
            ref={setRightSlotRef}
            className="absolute right-0 top-0 w-1/2 h-full rounded-r-md pointer-events-auto"
            style={isOverRight ? { boxShadow: '0 0 0 2px rgba(255,255,255,0.9), 0 0 16px rgba(255,255,255,0.7)' } : undefined}
          />
        </>
      )}
      {hasOneSlot && (
